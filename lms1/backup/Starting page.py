...
"==============================================================MAIN FRAME=========================================================================================================================="
txtsearch=Button(mainframe, text= "Search...                                                                                                                                                               ", font=('arial', 20), bg="white", width= 87, height= 0, command=lambda: show_frame(search))
txtsearch.place(x= 275, y=400)

frame1_insert = tk.Button(mainframe, text='ISSUE', fg='white', command=lambda: show_frame(issue), bg="#1E1E20", padx=200, pady=20)
frame1_insert.place(x=150, y=750)

frame1_return = tk.Button(mainframe, text='RETURN',fg='white', command=lambda: show_frame(frame5), bg="#1E1E20", padx=200, pady=20)
frame1_return.place(x=738, y=750)

frame1_extention = tk.Button(mainframe, text='EXTENTION',fg='white', command=lambda: show_frame(frame6), bg="#1E1E20", padx=200, pady=20)
...
comSearch["value"]=("Book","Records", "Admission No.")
